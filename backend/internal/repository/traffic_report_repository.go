...
type TrafficReportRepository interface {
	...
	ListSuccessfulRuns(ownerID uint64) ([]model.TrafficReportRun, error)
...
func (r *trafficReportRepository) ListSuccessfulRuns(ownerID uint64) ([]model.TrafficReportRun, error) {
