...
var BuiltinPermissions = []PermissionDef{
	...
	{Code: "settlement.data.read", Name: "结算数据明细-查看", Description: s("查看结算数据明细列表")},
	{Code: "settlement.data.export", Name: "结算数据明细-导出", Description: s("导出结算数据明细")},
	{Code: "settlement.data.recalculate", Name: "结算数据明细-复算", Description: s("按服务时间范围复算并覆盖")},
	...
	{Code: "rates.customer.export", Name: "客户业务费率导出", Description: s("导出客户业务费率与模板下载")},
	{Code: "rates.customer.import", Name: "客户业务费率导入", Description: s("导入客户业务费率（CSV/Excel）")},
	...
	// Rates - discount rules
	{Code: "rates.discount_rule.read", Name: "折损规则查看", Description: s("查看折损规则及明细")},
	{Code: "rates.discount_rule.manage", Name: "折损规则维护", Description: s("新增/修改/删除折损规则及明细")},
