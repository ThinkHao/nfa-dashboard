...
func BuildEngine() *gin.Engine {
	...
	edcNFAComparisonRepo := repository.NewEDCNFAComparisonRepository()
	edcNFAComparisonService := service.NewEDCNFAComparisonService(edcNFAComparisonRepo)
	...
	edcNFAComparisonController := controller.NewEDCNFAComparisonController(edcNFAComparisonService, edcScopeService, trafficScopeService, systemSettingsSvc, settlementParticipationSvc)
	...
	api := r.Group("/api/v1")
	{
		...
		v2 := r.Group("/api/v2")
		{
			...
			v2.GET("/edc-nfa/comparison-groups", authMW.AuthRequired(), authMW.PermissionRequired("traffic.read"), edcNFAComparisonController.ListGroups)
