  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'settlement/rates/sync-rules', name: 'settlement-rates-sync-rules', component: () => import('../views/SyncRulesView.vue'), meta: { title: '同步规则管理', permissions: ['rates.sync_rules.read'], order: 39, icon: '🔄' } },
        { path: 'settlement/entities', name: 'settlement-entities', component: () => import('../views/SettlementEntitiesView.vue'), meta: { title: '业务对象', permissions: ['entities.read'], cache: true, order: 35, icon: '🧩' } },
        { path: 'settlement/business-types', name: 'settlement-business-types', component: () => import('../views/BusinessTypesView.vue'), meta: { title: '业务类型管理', permissions: ['business_types.read'], cache: true, order: 36, icon: '📦' } },
