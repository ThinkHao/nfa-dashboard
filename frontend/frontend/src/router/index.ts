  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'traffic-comparison', name: 'traffic-comparison', component: () => import('../views/EDCNFAComparisonView.vue'), meta: { title: 'EDC/NFA 对比', permissions: ['traffic.read'], order: 1, icon: 'DataAnalysis', group: 'traffic-analysis' } },
        { path: 'edc-nfa-mappings', name: 'edc-nfa-mappings', component: () => import('../views/EDCNFAMappingView.vue'), meta: { title: 'EDC/NFA 映射', permissions: ['traffic.scope.manage'], order: 2, icon: 'Setting', group: 'traffic-analysis' } },
        { path: 'traffic-reports', name: 'traffic-reports', component: () => import('../views/TrafficReportsView.vue'), meta: { title: '流量报表', permissions: ['traffic.report.read'], order: 13, icon: 'Document' } },
        ...
        { path: 'settlement/rates/final-node', name: 'settlement-rates-final-node', component: () => import('../views/FinalNodeRatesView.vue'), meta: { title: '最终节点费率', permissions: ['rates.node.read'], cache: true, order: 34, icon: 'CircleCheck', group: 'settlement-config' } },
