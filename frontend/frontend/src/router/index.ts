  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'settlement/user-query', name: 'settlement-user-query', component: () => import('../views/SettlementUserQueryView.vue'), meta: { title: '单用户结算查询', permissions: ['settlement.data.read'], order: 33, icon: '👤', group: 'settlement-dashboard' } },
        ...
        { path: 'settlement/rates/discount-rules', name: 'settlement-rates-discount-rules', component: () => import('../views/DiscountRulesView.vue'), meta: { title: '折损规则管理', permissions: ['rates.discount_rule.read'], order: 38, icon: '🪙', group: 'settlement-config' } },
        { path: 'settlement/channels', name: 'settlement-channels', component: () => import('../views/ChannelSettlementView.vue'), meta: { title: '用户维度结算', permissions: ['settlement.results.read'], order: 34, icon: '🧮', group: 'settlement-dashboard' } },
