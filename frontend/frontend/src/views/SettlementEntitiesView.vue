    ...
    <el-card shadow="never" class="box-card">
      ...
      <el-form :inline="true" :model="query" label-width="90px" class="filter-form">
        <el-form-item label="类型">
          <el-input v-model="query.entity_type" clearable placeholder="如 customer/vendor" style="width: 200px" />
        </el-form-item>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑业务对象' : '新增业务对象'" width="560px">
      <el-form :model="form" label-width="110px">
        <el-form-item label="类型" required>
          <el-input v-model="form.entity_type" />
        </el-form-item>
...
import api from '@/api'
import type { BusinessEntity, PaginatedData, CreateBusinessEntityRequest, UpdateBusinessEntityRequest } from '@/types/api'
